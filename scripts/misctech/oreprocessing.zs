...
impure_gold_riffle.addItemOutput(<ore:riffleImpureGold>.firstItem * 6);
...
gold_riffle.addItemInput(<ore:riffleImpureGold>.firstItem * 256);
gold_riffle.addItemOutput(<ore:riffleGold>.firstItem * 64);
gold_riffle.addItemOutput(<ore:riffleGold>.firstItem * 64);
gold_riffle.addItemOutput(<ore:riffleGold>.firstItem * 64);
gold_riffle.addItemOutput(<ore:riffleGold>.firstItem * 64);
gold_riffle.build();
...
mercury_gold_amalgam.addItemInput(<ore:riffleGold>.firstItem * 6);
...
impure_silver_riffle.addItemOutput(<ore:riffleImpureSilver>.firstItem * 6);
...
silver_riffle.addItemInput(<ore:riffleImpureSilver>.firstItem * 256);
silver_riffle.addItemOutput(<ore:riffleSilver>.firstItem * 64);
silver_riffle.addItemOutput(<ore:riffleSilver>.firstItem * 64);
silver_riffle.addItemOutput(<ore:riffleSilver>.firstItem * 64);
silver_riffle.addItemOutput(<ore:riffleSilver>.firstItem * 64);
silver_riffle.build();
...
mercury_silver_amalgam.addItemInput(<ore:riffleSilver>.firstItem * 6);
...
washed_zircon_ore_dust.addItemInput(<ore:dustDirtyZirconium>.firstItem * 24);
