...
game.setLocalization("item.contenttweaker.glass_plate.name", "Glass Plate");
game.setLocalization("item.contenttweaker.lapis_plate.name", "Lapis Plate");
game.setLocalization("item.contenttweaker.emerald_plate.name", "Emerald Plate");
