...
Blueprint.addRecipe("Rocket Components", <advancedrocketry:rocketmotor>, [<contenttweaker:titanium_aluminide_scaffolding_panel> * 2, <contenttweaker:catalytic_turbopump>, <contenttweaker:small_titanium_pipe> * 4, <contenttweaker:rocket_engine_bell>]);
Blueprint.addRecipe("Rocket Components", <advancedrocketry:bipropellantrocketmotor>, [<contenttweaker:titanium_aluminide_scaffolding_panel> * 2, <contenttweaker:turbopump>, <contenttweaker:small_titanium_pipe> * 4, <contenttweaker:rocket_engine_bell>]);
Blueprint.addRecipe("Rocket Components", <advancedrocketry:advbipropellantrocketmotor>, [<contenttweaker:maraging_steel_scaffolding_panel> * 2, <contenttweaker:turbopump>, <contenttweaker:small_titanium_pipe> * 4, <contenttweaker:advanced_rocket_engine_bell>]);
